...
public partial class Infraciones_Page : ContentPage
{
	...
	private async void btnGuardar_Clicked(object sender, EventArgs e)
	{
							...
							{   /* PASO DEL DIABLO :v */
								...
								if (index != -1)
								{
									...
									if (await App.DataBase.DeleteTable<Infracciones>() > 0)
									{
										...
										errorInfraccion = "OCURRIÓ UN ERROR AL GUARDAR LA INFRACCIÓN EN SERVIDOR LOCAL";
        ...
        if (errorFolio != "")
        {
            ...
            DisplayAlert("Información", errorFolio, "OK");
            errorFolio = "";
        }
        ...
        if (errorInfraccion != "")
		{
            ...
            DisplayAlert("Información", errorInfraccion, "OK");
            errorInfraccion = "";
        }

		if(errorImpresora != "")
		{
			DisplayAlert("Información", errorImpresora, "OK");
			errorImpresora = "";
		}
